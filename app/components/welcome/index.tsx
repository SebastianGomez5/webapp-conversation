      ...
      <div className='mx-auto pc:w-[794px] max-w-full mobile:w-full px-3.5'>
        ...
        {!hasSetInputs && (
          <div className='mt-4 flex justify-between items-center h-8 text-xs text-gray-400'>
            ...
            <a className='flex items-center pr-3 space-x-3 hover:opacity-80 transition-opacity' href="https://studioalvarodiaz.es/" target="_blank" rel="noreferrer">
              <span className='uppercase'>{t('app.chat.powerBy')} Studio Álvaro Díaz</span>
              <FootLogo />
            </a>
          </div>
        )}
